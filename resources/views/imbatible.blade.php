...
<head>
    ...
    <meta name="description"
        content="Descubre la experiencia IMBATIBLE EDICIÓN BUSCANDO EL ALBA. Únete a nuestro desafío de ciclismo nocturno y enfrenta tus límites mientras cazamos juntos el primer rayo de sol. ¡Regístrate ahora y prepárate para una jornada inolvidable llena de aprendizaje, diversión y conexión con otros apasionados como tú!">
...
<body>
    ...
    @isset($success)
        ...
        <div class="whatsapp-icon">
            <a href="https://api.whatsapp.com/send?phone=573213028666&text=Hola,%20estoy%20interesado%20en%20obtener%20m%C3%A1s%20informaci%C3%B3n%20sobre%20el%20evento%20IMBATIBLE."
                target="_blank">
        ...
        <section class="section section_carrousel w-100" id="inicio">
            ...
            <div class="section_counter">
                ...
                <a href="https://www.instagram.com/reel/C1ccVRpuJyM/" target="_blank" class="btn btn-primary"><i
                        class="fa-solid fa-film"></i> VIDEO 1RA EDICIÓN</a>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <article>
                            ...
                            <img src=" {{ asset('./img/rule_01.webp') }}" alt="imagen explicativa de reglas"
                                class="article_rules_img">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <article>
                            ...
                            <img src="{{ asset('./img/rule_02.webp') }}" alt="imagen explicativa de reglas"
                                class="article_rules_img">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <article>
                            ...
                            <img src="{{ asset('./img/rule_03.webp') }}" alt="imagen explicativa de reglas"
                                class="article_rules_img">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <article>
                            ...
                            <img src="{{ asset('./img/rule_04.webp') }}" alt="imagen explicativa de reglas"
                                class="article_rules_img">
        ...
        <section class="section section_007" id="kit">
            ...
            <div class="text-center py-5">
                <a href="https://drive.google.com/drive/folders/1Oe91e1MxgcQdzJoFmUXoR1mbQFnn9vMw" target="_blank" class="btn btn-primary"><i
                        class="fa-solid fa-camera"></i> VER FOTOS 1RA EDICIÓN </a>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="contador_inscripciones">
                            ...
                            <a href="/registro" class="btn btn-primary"><i class="fa-solid fa-person-biking"></i>
        ...
        <section class="section section_005" id="patrocinadores">
            <div class="container">
                ...
                <span class="content_sponsor">
                    <a href="https://14ochomiles.com/wahoo" aria-label="Visitar sitio oficial de wahoo"
                        target="_blank"><span class="sponsor_logo sponsor_logo_a "></span></a>
                    <a href="https://www.escarabajosfoods.com/" aria-label="Visitar sitio oficial de escarabajosfood"
                        target="_blank"><span class="sponsor_logo sponsor_logo_b"></span></a>
                    <a href="https://14ochomiles.com/" aria-label="Visitar sitio oficial de 14ochomiles"
                        target="_blank"><span class="sponsor_logo sponsor_logo_c"></span></a>
                    <a href="https://www.mazda.com.co/" aria-label="Visitar sitio oficial de mazda" target="_blank"><span
                            class="sponsor_logo sponsor_logo_d"></span></a>
                    <a href="https://phigma.co/" aria-label="Visitar sitio oficial de phigma" target="_blank"><span
                            class="sponsor_logo sponsor_logo_e"></span></a>
                    <a href="https://www.ramo.com.co/" aria-label="Visitar sitio oficial de ramo" target="_blank"><span
                            class="sponsor_logo sponsor_logo_f"></span></a>
                </span>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 d-flex flex-column gap-4">
                        <div class="footer_b1">
                            <img src="{{ asset('./img/logo/logo_inline.png') }}" alt="imagen de cierre web"
                                class="w-50">
                            <p>Explora IMBATIBLE en nuestras redes y únete a nuestra comunidad de aventureros del ciclismo.
                            </p>
                        </div>
                        <div class="social_media">
                            <a href="https://www.instagram.com/imbatible__/" target="_blank" class="text-white"><i
                    ...
                    <div class="col-md-4">
                        <ul class="footer_b2">
                            <li>
                                <a href="https://drive.google.com/drive/folders/1Oe91e1MxgcQdzJoFmUXoR1mbQFnn9vMw"
                                    target="_blank">
                    ...
                    <div class="col-md-4 footer_b3">
                        <p>¡Únete a la aventura de IMBATIBLE! Regístrate ahora para asegurar tu lugar en la línea de
                            partida.</p>
                        <a href="/registro" class="btn btn-primary"><i class="fa-solid fa-person-biking"></i> Registrate
                            aquí</a>
                    </div>
                </div>
            </div>
