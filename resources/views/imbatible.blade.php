...
<body>
  ...
  <section class="section section_carrousel w-100" id="inicio">
    ...
    <div class="section_counter">
      <div class="titulo_header">
        <span class="title_one">¡EDICIÓN BUSCANDO EL ALBA! </span>
        <img src="{{ asset('./img/logo/logo_white.svg')}}" alt="Logo imbatible segunda edición" class="logo_carrouse my-5">
        <span class="text-center">SÚPERA TUS LÍMITES INSCRÍBETE A IMBATIBLE</span>
      </div>
      <div class="contador" id="contador"></div>
      <a href="/registro" target="_blank" class="btn btn-primary"><i class="fa-solid fa-person-biking"></i> Registrate aquí</a>
    </div>
  </section>
          ...
          <div class="content_article">
            <article>
              ...
              <p class="paragrahp_section">
                IMBATIBLE es un reto de ciclismo diferente, donde cada participante buscará superar sus límites,
                enfrentándose a un exigente recorrido y a la incertidumbre de lo que pueda suceder en el camino. Muchos
                kilómetros y desnivel de retro inspección, buscando una mejor versión, nuestro propósito es sacar a
                flote ese espíritu inquebrantable que todos llevamos dentro, pero muchas veces desconocemos.
              </p>
            </article>
            <article>
              <p class="paragrahp_section">
                En IMBATIBLE, nos sumergimos en una travesía que va más allá de la competencia física. Es un viaje hacia
                el
                interior de cada participante, donde se descubre una fortaleza hasta entonces desconocida. A través de
                cada
                pedaleo, se revela un espíritu resiliente, capaz de enfrentar los desafíos más grandes con determinación
                y
                coraje. En este recorrido, no solo se conquistan kilómetros, sino también se conquista la confianza en
                uno
                mismo y en la capacidad de superar cualquier obstáculo que se presente en el camino.
              </p>
            </article>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 section_002_item">
          <div class="content_article">
            <article>
              <span class="title title_section">DESAFIANDO LA OSCURIDAD HACIA LA LUZ DEL AMANECER</span>
              <p class="paragrahp_section">
                El 27 de julio llega la segunda edición de IMBATIBLE, en esta ocasión el objetivo
                es recorrer de manera autoasistida 238 km con 5400 metros de desnivel
                positivo y subiremos el nivel de dificultad teniendo como largada la luz de la luna,
                iniciaremos el recorrido de noche e iremos en busca del amanecer, iremos
                cazando la luz del primer rayo de sol al tiempo que superamos nuestros miedos.
              </p>
              <p class="paragrahp_section">
                La salida será en la Vega Cundinamarca, y para ser considerados finalistas
                oficiales tendrán que pasar por tres puntos de control obligatorios y llegar a la
                meta antes del tiempo límite de 13 horas para hombres y 14 horas para mujeres.
              </p>
              <p class="paragrahp_section">
                ¿Cuál es la Meta y el recorrido? Esta información solo será compartida a los
                inscritos al evento y socializada en el congresillo técnico, pero te adelantamos que
                la llegada cerca a Bogotá (2 horas aprox. en vehículo).
              </p>
            </article>
          </div>
        </div>
      ...
      <div class="row flex_inverse_section_item">
        <div class="col-md-6 section_002_item">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-6 col-xl-3">
          <article>
            ...
            <p class="paragrahp_section">Está <strong>prohibido</strong> el apoyo de terceros como motos, vehículos
              acompañantes o
              ciclistas gregarios fuera de los
              inscritos. Cada ciclista inscrito será autónomo en la asistencia de problemas mecánicos, alimentación u
              otros, aunque contará con acompañamiento de la organización y dos puntos de abastecimiento.</p>
          </article>
        </div>
        <div class="col-md-6 col-lg-6 col-xl-3">
          <article>
            ...
            <p class="paragrahp_section">Para ser considerado finisher debes completar el recorrido en máximo
              13 horas, además de pasar obligatoriamente por los puntos de control.</p>
          </article>
        </div>
        <div class="col-md-6 col-lg-6 col-xl-3">
          <article>
            <div class="subtitle_section">3. Condiciones de inscripción</div>
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
          <article>
            ...
            <p class="paragrahp_section">EEl ciclista que reciba ayuda externa será descalificado de la
  ...
  <section class="section section_003" id="premiacion">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <p class="paragrahp_section">Premiación en efectivo, categorías únicas, masculina y femenina, para acceder a
          ...
          <p class="paragrahp_section mt-5 fw-medium text-info">*En caso de no obtener el mínimo de inscritos por
  ...
  <section class="section section_007" id="kit">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <span class="img_item img_item_01"></span>
          <span class="title_item">Jersey oficial IMBATIBLE x Phigma</span>
        </div>
        <div class="col-md-6">
          <span class="img_item img_item_02"></span>
          <span class="title_item">Maletín de manillar FOLK 1L</span>
        </div>
      </div>
      <div class="content_items">
        ...
        <div class="items">
          ...
          <span class="title_item">Recordatorio de Finisher <br> (Exclusivo finalistas antes del tiempo límite)</span>
        </div>
        <div class="items">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          ...
          <p class="paragrahp_section">¡Bienvenidos al evento que estabas esperando! Estamos emocionados de invitarte a
            participar en esta experiencia única que te llevará a nuevos desafíos y logros. En IMBATIBLE EDICIÓN
            BUSCANDO EL ALBA, nos comprometemos a brindarte una jornada inolvidable, llena de aprendizaje, diversión y
            conexión con otros apasionados como tú. Para asegurar tu lugar en esta aventura, te proporcionamos todos los
          ...
          <ol class="paragrahp_section">
            ...
            <li>Ve al <a href="/registro" target="_blank" class="text-info">formulario de inscripción</a> </li>
            <li>Diligencia y adjunta el soporte de pago</li>
            <p>(Luego de confirmado el pago y corroborados los datos, recibirás correo
              electrónico con link para unirte al grupo de WhatsApp oficial del evento).</p>
            <li>Recibirás correo con link para unirte al grupo oficial de inscritos a IMBATIBLE
              BUSCANDO EL ALBA.</li>
          </ol>
        ...
        <div class="col-md-12 col-lg-12">
          <div class="contador_inscripciones">
            ...
            <a href="/registro" class="btn btn-primary"><i class="fa-solid fa-person-biking"></i> Registrate aquí</a>
          </div>
        </div>
      </div>
  </section>
      ...
      <div class="row">
        <div class="col-md-4 d-flex flex-column gap-4">
          <div class="footer_b1">
            ...
            <p>Explora IMBATIBLE en nuestras redes y únete a nuestra comunidad de aventureros del ciclismo.</p>
          </div>
        ...
        <div class="col-md-4 footer_b3">
          <p>¡Únete a la aventura de IMBATIBLE! Regístrate ahora para asegurar tu lugar en la línea de partida.</p>
          <a href="/registro" class="btn btn-primary"><i class="fa-solid fa-person-biking"></i> Registrate aquí</a>
        </div>
      </div>
    </div>
