            ...
            <div class="container">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="mb-5">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-primary" aria-current="page"><a href="/inscritos">Inscritos</a></li>
                ...
                <div class="card p-5">
                    <div class="card-body d-flex flex-column gap-3">
                        <span class="d-flex justify-content-between  align-items-center">
                            ...
                            <span>
                                <a href="{{ route('preinscritos.estado.update', $inscrito) }}" class="btn btn-danger">
