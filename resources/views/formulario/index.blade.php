...
<body>
    <nav class="navbar" style="background-color:#176b87; height: 25vh;">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('/img/logo/logo_inline.png') }}" alt="Logo imbatible" class="logo_nav_movile" width="120" />
                <h4 class="text-white opacity-50">Formulario de Inscripción para IMBATIBLE: ¡Prepárate para el Desafío!</h4>
            </a>
        </div>
    </nav>
    <div class="container mt-5">
        ...
        <form method="POST" action="{{ route('inscritos.store') }}" class="d-flex flex-column gap-4" id="registerImbatible" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary w-25 m-auto">Realizar Inscripción</button>
        </form>
